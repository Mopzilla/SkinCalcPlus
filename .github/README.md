# SkinCalcPlus (SC+)
SC+ is a browser extension that enhances the Skin.Club experience by adding useful features such as case statistics, giveaway odds, live battle tracking, and more.
...
Have any questions, ideas, or want to discuss SC+ in general?</br>[Head over to the discussions page and start a discussion!](https://github.com/Mopzilla/SkinCalcPlus/discussions)
## Table of Contents
- [SkinCalcPlus (SC+)](#skincalcplus-sc)
